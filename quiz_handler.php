        ...
        <div class="card mt-5">
          ...
          <div class="card-body">
            ...
            if ($score >= 7) {
              ...
              echo '<center><a href="quiz-media.html" class="btn btn-primary">Take Again</a> <a href="index.html#topics" class="btn btn-primary">Go to a new Topic</a></center>';
            } else {
              // If the score is less than 7, allow the user to try the quiz again
              echo '<center><a href="quiz-media.html" class="btn btn-primary">Try Again</a></center>';
            }
            ?>
